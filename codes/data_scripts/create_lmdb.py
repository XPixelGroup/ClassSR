...
def main():
    ...
    if dataset == 'vimeo90K':
        ...
        opt = {}
        opt['img_folder'] = '/home/xtkong/datasets/DIV2K/DIV2K800_960sub_bicLRx4'
        opt['lmdb_save_path'] = '/home/xtkong/datasets/DIV2K/DIV2K800_960sub_bicLRx4.lmdb'
        opt['name'] = 'DIV2K800_sub_LR'
        general_image_folder(opt)
    elif dataset == 'DIV2K_demo':
        opt = {}
        ## GT
        opt['img_folder'] = '/home/hyzhao/xtkong/mmsr/datasets/DIV2K_train_HR_480sub'
        opt['lmdb_save_path'] = '/home/hyzhao/xtkong/mmsr/datasets/DIV2K_train_HR_480sub.lmdb'
        opt['name'] = 'DIV2K200_sub'
        general_image_folder(opt)
        ## LR
        opt['img_folder'] = '/home/hyzhao/xtkong/mmsr/datasets/DIV2K_train_LR_480sub'
        opt['lmdb_save_path'] = '/home/hyzhao/xtkong/mmsr/datasets/DIV2K_train_LR_480sub.lmdb'
        opt['name'] = 'DIV2K200_sub_LR'
        general_image_folder(opt)
    elif dataset == 'test':
